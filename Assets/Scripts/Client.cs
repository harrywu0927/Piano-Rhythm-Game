...
public class Client
{
    ...
    {
        //if (pack.Requestcode.ToString() == "UserControl")
        //{
            ...
            //Debug.Log("MagicClass.ItsMagic() returned: {0}"+ magicValue.Loginpack.Username + " " + magicValue.Loginpack.Password);
            //Console.WriteLine(magicValue.Requestcode);
            //return magicValue;
        //}
    }
